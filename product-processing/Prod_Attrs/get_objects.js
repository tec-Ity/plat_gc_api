api = "https://example.com/api/v1/Attrs";
api = "https://example.com/api/v1/Attrs?"+"&[key in args]=[args[key]]";
/* 
	"example": [
		"https://example.com/api/v1/Attrs?search=N",
		"https://example.com/api/v1/Attrs?search=N&page=2&sortKey=code&sortVal=1",
	],
*/
fetchObj = {
    methods: "GET",
