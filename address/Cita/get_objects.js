...
/* 
	"EX_url": [
		"https://example.com/api/v1/Citas?search=N",
		"https://example.com/api/v1/Citas?search=N&page=2&sortKey=code&sortVal=1",
	],
*/
req = {
	url: "https://example.com/api/v1/Citas?"+"[key in this.args]=[args[key]]",
	methods: "GET",
	headers: {
