...
/* 
    "EX_url": [
        "https://example.com/api/v1/Areas?search=N",
        "https://example.com/api/v1/Areas?search=N&page=2&sortKey=code&sortVal=1",
    ],
*/
req = {
    url: "https://example.com/api/v1/Areas?"+"&[key in args]=[args[key]]",
    methods: "GET",
    headers: {
